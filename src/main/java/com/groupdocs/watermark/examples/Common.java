...
public class Common {
	...
	public static final Path STORAGE_PATH = getProjectBaseDir().resolve("D:\\myrepo\\GroupDocs.Watermark.crack\\GroupDocs.Watermark.crack\\Data\\Source");
	public static final Path OUTPUT_PATH = getProjectBaseDir().resolve("D:\\myrepo\\GroupDocs.Watermark.crack\\GroupDocs.Watermark.crack\\Data\\Output");
	...
	public static String LICENSE_PATH = "D:\\GroupDocs.Watermark.lic";
	...
	public static void applyLicenseFromStream() {
		try {
			...
			// Setup license
			License lic = new License();
			lic.setLicense(new FileInputStream(LICENSE_PATH));
	...
	public static String mapSourceFilePath(String STORAGE_PATH, String inputFileName) {
		try {
			return getProjectBaseDir().resolve(STORAGE_PATH) + "/" + inputFileName;
		} catch (Exception e) {
			e.printStackTrace();
			return e.getMessage();
		}
	...
	public static String mapOutputFilePath(String OUTPUT_PATH, String outputFileName) {
		try {
			return getProjectBaseDir().resolve(OUTPUT_PATH) + "/" + outputFileName;
		} catch (Exception e) {
			e.printStackTrace();
			return e.getMessage();
		}
