...
public class MainClass {
	public static void main(String[] args) throws Throwable {
		...
		// Remove watermark
		 Documents.PDF.removeWatermark("D:\\myrepo\\GroupDocs.Watermark.crack\\GroupDocs.Watermark.crack\\Data\\Source", "D:\\myrepo\\GroupDocs.Watermark.crack\\GroupDocs.Watermark.crack\\Data\\Output", "input.pdf", "山西省农村信用社.*");
